  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-10">
        ...
        >
          I am Prathamesh Malode, an undergraduate at MMIT Pune and a full-stack web developer and Flutter Application Developer,
        ...
        <Tilt className="mx-auto my-auto green-pink-gradient p-[1px] rounded-[20px] shadow-card">
          <motion.button
            className="bg-tertiary text-secondary px-10 py-5 rounded-[20px]"
            onClick={() => {
              window.location.href = 'https://docs.google.com/document/d/1240m9lXrUgxdg2mztyTlj7-6zRgarasP/edit?usp=sharing&ouid=114809551013505878955&rtpof=true&sd=true'; 
            }}
          >
            Resume
          </motion.button>
